package com.sky.shellservice.service;
...
public class ShellService {
    ...
    public void service(String shellName) throws Exception {
        ...
        try {
            //获取脚本所在的目录
            String configFilePath = Thread.currentThread().getContextClassLoader().getResource("application.properties").getPath();
    ...
    private void callScript(String script) throws Exception {
        try {
            String cmd = "sh " + script +" /Users/skynj/Desktop/project/mobile/YTH_ALL_Project/GCSX_YTH/YTHPTCordova/ " +" /Users/skynj/Desktop/target/ "
                    +" GCSX " + " 46cd99db-a520-4a79-8c44-8eabd9b4aaec ";
